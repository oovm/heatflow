...
namespace RsBind
{
    internal static unsafe partial class RsMethods
    {
        ...
        [DllImport(__DllName, EntryPoint = "delete_heat_map", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        [DllImport(__DllName, EntryPoint = "heat_map_get_h", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern nuint heat_map_get_h(void* heat_map);
